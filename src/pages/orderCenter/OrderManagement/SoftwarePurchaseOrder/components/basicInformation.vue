<template>
  <section class="p-hardware-con" v-loading="checkBasicInformLoad">
    ...
    <div class="p-hardware-action">
      ...
      <el-button size="small" type="primary" v-if="$route.query.status === 'edit'" v-permission="'SOFT_PURCHASE_ORDER_SUBMIT'" :loading="checkVerifyBtnLoad" @click="handleVerify">提交</el-button>
