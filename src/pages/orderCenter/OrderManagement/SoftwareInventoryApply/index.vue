        ...
        <el-row type="flex" align="bottom">
          <el-col :xl="22" :lg="21">
            ...
            <el-form-item style="margin-left:80px">
              ...
              <km-export-view ref="export" v-permission="'SOFTWARE_INVENTORY_APPLY_EXPORT'" :request-export-log="handleExportRecord" :request-export-del="handleExportDel" />
            </el-form-item>
          </el-col>
      ...
      <el-table :data="tableData">
        ...
        <el-table-column label="操作" fixed="right" width="150">
          <template slot-scope="scope">
            ...
            <el-button v-if="userInfo.level === 1" type="text" size="small" @click="handleToDetail({ status: 'detail' }, scope.row)">审核</el-button>
  ...
  methods: {
    ...
    handleToDetail(status, row = {}) {
      this.delCachedView({ name: 'softwareInventoryApplyDetails' }).then(() => {
        this.$router.push({ name: 'softwareInventoryApplyDetails', query: { ...status, id: row.id, orderStatus: row.orderType } })
      })
    },
