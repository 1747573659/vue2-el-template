  ...
  <section>
      ...
      <el-form size="small" :model="form" :inline="true" label-suffix=":" label-width="80px" @submit.native.prevent>
        ...
        <el-col :xl="2" :lg="3" style="text-align:right">
          <el-form-item v-permission="'DEMAND_DEVELOPMENT_FEE_PLUS'">
            <el-button type="primary" size="small" plain icon="el-icon-plus" @click="handleSoftWareDetail({ status: 'add' })">ERP产品</el-button>
          </el-form-item>
        </el-col>
      </el-form>
    </div>
    <div class="data-box" v-loading="checkTabLock">
      <el-table :data="tableData">
        ...
        <el-table-column prop="handUserName" label="升级费用"></el-table-column>
        <el-table-column prop="handUserName" label="付款状态"></el-table-column>
