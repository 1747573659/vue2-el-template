    ...
    <el-card shadow="never" class="p-card">
      ...
      <el-form :model="form" size="small" disabled :inline="true" label-suffix=":" label-width="110px">
        ...
        <el-form-item label="商户号">
          <el-input :value="form.oldMerchantId"></el-input>
        </el-form-item>
        <el-form-item label="授权状态">
          <el-input :value="form.oldMerchantAuthType ? '试用' : '正式'"></el-input>
        </el-form-item>
        <el-form-item label="产品">
          <el-input :value="`${form.oldMerchantProductCode ? '[' + form.oldMerchantProductCode + ']' : ''}${form.oldMerchantProductCodeName || ''}`"></el-input>
        </el-form-item>
        <el-form-item label="地区">
          <el-input :value="form.oldAddress"></el-input>
        </el-form-item>
        <el-form-item label="门店授权站点">
          <el-input :value="form.oldMerchantAuthCount"></el-input>
        </el-form-item>
      </el-form>
    </el-card>
    <el-card shadow="never" class="p-card">
      ...
      <el-form :model="form" size="small" disabled :inline="true" label-suffix=":" label-width="110px">
        ...
        <el-form-item label="商户号">
          <el-input :value="form.newMerchantId"></el-input>
        </el-form-item>
        <el-form-item label="授权状态">
          <el-input :value="form.newMerchantAuthType ? '试用' : '正式'"></el-input>
        </el-form-item>
        <el-form-item label="产品">
          <el-input :value="`${form.newMerchantProductCode ? '[' + form.newMerchantProductCode + ']' : ''}${form.newMerchantProductCodeName || ''}`"></el-input>
        </el-form-item>
        <el-form-item label="地区">
          <el-input :value="form.newAddress"></el-input>
        </el-form-item>
        <el-form-item label="门店授权站点">
