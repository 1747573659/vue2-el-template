  ...
  <div class="app-container">
    <div class="action-box">
      <km-form :inline="true" @submit.native.prevent>
        <km-form-item label="享钱订单号">
          <km-input @input="setInputNum" placeholder="享钱订单号" v-model.trim="orderType"></km-input>
        </km-form-item>
        <km-form-item label="ERP(线下)订单号">
          <km-input @input="setInputNumOrWord" placeholder="ERP(线下)订单号" v-model.trim="processOrderNum"></km-input>
        </km-form-item>
        <km-form-item label="微信/支付宝流水号">
          <km-input @input="setInputNum" placeholder="微信/支付宝流水号" v-model.trim="serialNumber"></km-input>
        </km-form-item>
        <section>
          <km-form-item label="退款订单号">
            <km-input @input="setInputNum" placeholder="退款订单号" v-model.trim="serialNumber"></km-input>
          </km-form-item>
          <km-form-item>
    ...
    <div class="data-box" v-loading="tabLock">
      <km-table :data="tabData" ref="table">
        <km-table-column label="申请退款时间" prop="createTime"></km-table-column>
        <km-table-column label="退款订单号" prop="createTime"></km-table-column>
        <km-table-column label="订单号" prop="createTime"></km-table-column>
        <km-table-column label="商户名称" prop="createTime"></km-table-column>
        <km-table-column label="门店名称" prop="createTime"></km-table-column>
        <km-table-column label="退款人" prop="createTime"></km-table-column>
        <km-table-column label="申请退款金额" prop="createTime"></km-table-column>
        <km-table-column label="退款状态" prop="createTime"></km-table-column>
