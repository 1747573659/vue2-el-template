  ...
  <div>
        ...
        <el-col :span="4" style="text-align: right;">
          ...
          <el-dropdown style="margin-left: 12px;">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item
                v-permission="'MERCHANT_BATCH_STOP'"
                @click.native="batchOperate(0)"
                >批量停用</el-dropdown-item
              >
              <el-dropdown-item
                v-permission="'MERCHANT_BATCH_START'"
                @click.native="batchOperate(1)"
                >批量启用</el-dropdown-item
              >
              <el-dropdown-item
                v-permission="'MERCHANT_BATCH_CLERK'"
                @click.native="batchSubmitClerk()"
                >移交业务员</el-dropdown-item
              >
            </el-dropdown-menu>
          </el-dropdown>
        </el-col>
    ...
    <div class="data-box">
      ...
      >
        ...
        <el-table-column prop="storeNum" label="门店数"> </el-table-column>
        ...
        <el-table-column label="操作" align="right" width="180">
          <template slot-scope="scope">
            <el-button
              v-permission="'MERCHANT_SET_EDIT'"
              size="small"
              type="text"
      ...
      >
        ...
        <div slot="footer" class="dialog-footer">
          <el-button size="small" @click="dialogFormVisible = false"
            >取 消</el-button
          >
          <el-button size="small" type="primary" @click="onClerkConfirm"
            >确 定</el-button
          >
        </div>
      </el-dialog>
