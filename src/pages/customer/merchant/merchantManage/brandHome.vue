        ...
        <el-col :span="20">
          ...
          >
            <el-form-item label="商户信息：">
              <el-input
                v-model="form.merchantAdminName"
                maxlength="50"
                placeholder="请输入商户编号/名称"
              ></el-input>
            </el-form-item>
      ...
      >
        ...
        <el-table-column label="操作" align="right" width="180">
          <template slot-scope="scope">
            ...
            >
            <el-button
              v-permission="'BRAND_SET_STOPANDSTART'"
              size="small"
              type="text"
