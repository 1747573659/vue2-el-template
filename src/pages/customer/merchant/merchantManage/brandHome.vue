  ...
  <div>
        ...
        <el-col :span="20">
          <el-form :inline="true" size="small" :model="form" label-width="85px" class="xdd-btn-block__w240">
            <el-form-item label="商户信息：">
              <el-input v-model="form.merchantAdminName" maxlength="50" placeholder="请输入商户编号/名称"></el-input>
            </el-form-item>
            <el-form-item label="品牌信息：">
              <el-input v-model="form.merchantName" maxlength="50" placeholder="请输入品牌编号/名称"></el-input>
            </el-form-item>
            <el-form-item>
    ...
    <div class="data-box">
      <el-table v-loading="loading" ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%">
        <el-table-column prop="adminId" label="商户编号">
        </el-table-column>
        <el-table-column prop="adminName" label="商户名称">
        </el-table-column>
        <el-table-column prop="mid" label="品牌编码">
        </el-table-column>
        <el-table-column prop="name" label="品牌名称">
        </el-table-column>
        <el-table-column prop="tradeTypeName" label="行业">
        </el-table-column>
