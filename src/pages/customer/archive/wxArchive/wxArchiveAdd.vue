<template>
  <section
    class="p-wxArchive-con"
    v-loading="isDetailLoad"
    v-permission.page="'WXARCHIVE_LIST_EDIT,WXARCHIVE_LIST_ADD'"
  >
    <header
      v-if="
        pageAction && pageAction !== 'add' && $route.query.status !== 'copy'
      "
    >
      <el-row v-if="pageAction === 'detail' && $route.query.status !== 'copy'">
        <el-col :span="12" v-if="form.archiveBaseVO.auditStatus !== ''">
          <label>进件状态：</label>
          <span class="e-wxArchive-status_pd e-wxArchive-warning">{{
            form.archiveBaseVO.auditStatus | filterReview
          }}</span>
        </el-col>
        <el-col
          :span="12"
          v-if="
            form.archiveBaseVO.auditRemark !== '' &&
            [1, 4].includes(form.archiveBaseVO.auditStatus)
          "
        >
          <label>审核结果：</label>
          <el-tooltip
            effect="dark"
            :content="form.archiveBaseVO.auditRemark"
            placement="top"
          >
            <span class="e-wxArchive-review">{{
              form.archiveBaseVO.auditRemark
            }}</span>
          </el-tooltip>
        </el-col>
    ...
    <section>
      ...
      >
          ...
          <el-row>
            ...
            <el-col :span="12" v-if="businessSceneList.includes(1)">
              <el-form-item label="公众号APPID" prop="archiveBaseVO.publicId">
                <el-input
                  v-model="form.archiveBaseVO.publicId"
            ...
            <el-col :span="12" v-if="businessSceneList.includes(2)">
              <el-form-item label="小程序APPID" prop="archiveBaseVO.appletId">
                <el-input
                  v-model="form.archiveBaseVO.appletId"
            ...
            <el-col :span="12">
              <el-form-item label="公司名称" prop="archiveBaseVO.companyName">
                <el-input
                  v-model="form.archiveBaseVO.companyName"
                  placeholder="公司名称"
                  style="width: 240px"
                ></el-input>
                <el-tooltip
            ...
            <el-col :span="12">
              <el-form-item
                label="商户简称"
                prop="archiveBaseVO.merchantShortName"
              >
                <el-input
                  v-model="form.archiveBaseVO.merchantShortName"
                  placeholder="商户简称"
                  style="width: 240px"
                ></el-input>
                <el-tooltip
                  effect="dark"
                  content="商户简称在消费者付款成功页展示，请认真填写"
                  placement="top"
                >
                  <img :src="questionIcon" alt="提示" class="e-icon-question" />
                </el-tooltip>
            ...
            <el-col :span="12">
              <el-form-item label="地区" prop="archiveBaseVO.area">
                <area-select
                  :key="areaKey"
                  @change="(value) => handleArea('area', value)"
                  :areaList="areaList"
                ></area-select>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="详细地址" prop="archiveBaseVO.address">
                <el-input
                  v-model="form.archiveBaseVO.address"
                  placeholder="详细地址"
                  style="width: 240px"
                ></el-input>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item label="联系人" prop="archiveBaseVO.contact">
                <el-input
                  v-model="form.archiveBaseVO.contact"
                  placeholder="联系人"
                  style="width: 240px"
                ></el-input>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item
                label="联系人电话"
                prop="archiveBaseVO.contactPhone"
              >
                <el-input
                  v-model="form.archiveBaseVO.contactPhone"
                  placeholder="联系人电话"
                  style="width: 240px"
                ></el-input>
              </el-form-item>
            ...
            <el-col :span="24">
              <el-form-item label="邮箱" prop="archiveBaseVO.email">
                <el-input
                  v-model="form.archiveBaseVO.email"
                  placeholder="邮箱"
                  style="width: 240px"
                ></el-input>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item
                label="门店门头照"
                prop="archiveOtherVO.signboardUrl"
              >
                <upload-pic
                  alt="门店门头照"
                  ...
                  @on-success="
                    (value) =>
                      setUploadSrc(value, 'archiveOtherVO', 'signboardUrl')
                  "
                  @click="
                    handleImgPreview(
                      fileServe + form.archiveOtherVO.signboardUrl
                    )
                  "
                >
                </upload-pic>
            ...
            <el-col :span="12">
              <el-form-item
                label="经营场所照1"
                prop="archiveOtherVO.businessSiteOneUrl"
              >
                <upload-pic
                  alt="经营场所照1"
                  :fileServer="fileServer"
                  ...
                  @click="
                    handleImgPreview(
                      fileServe + form.archiveOtherVO.businessSiteOneUrl
                    )
                  "
                ></upload-pic>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item
                label="经营场所照2"
                prop="archiveOtherVO.businessSiteTwoUrl"
              >
                <upload-pic
                  alt="经营场所照2"
                  :fileServer="fileServer"
                  ...
                  @click="
                    handleImgPreview(
                      fileServe + form.archiveOtherVO.businessSiteTwoUrl
                    )
                  "
                ></upload-pic>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item
                label="经营场所照3"
                prop="archiveOtherVO.businessSiteThreeUrl"
              >
                <upload-pic
                  alt="经营场所照3"
                  :fileServer="fileServer"
                  ...
                  @click="
                    handleImgPreview(
                      fileServe + form.archiveOtherVO.businessSiteThreeUrl
                    )
                  "
                ></upload-pic>
              </el-form-item>
            ...
            <el-col :span="12" v-if="form.archiveBaseVO.archiveType === 9">
              <el-form-item label="经营场地证明">
                <upload-pic
                  ...
                  @on-success="
                    (value) =>
                      setUploadSrc(value, 'archiveOtherVO', 'businessSiteUrl')
                  "
                  @click="
                    handleImgPreview(
                      fileServe + form.archiveOtherVO.businessSiteUrl
                    )
                  "
                ></upload-pic>
              </el-form-item>
            ...
            <el-col :span="12" v-if="form.archiveBaseVO.archiveType === 9">
              <el-form-item label="补充资料1">
                <upload-pic
                  ...
                  @on-success="
                    (value) =>
                      setUploadSrc(value, 'archiveOtherVO', 'additionalOneUrl')
                  "
                  @click="
                    handleImgPreview(
                      fileServe + form.archiveOtherVO.additionalOneUrl
                    )
                  "
                ></upload-pic>
              </el-form-item>
            ...
            <el-col :span="12" v-if="form.archiveBaseVO.archiveType === 9">
              <el-form-item label="补充资料2">
                <upload-pic
                  ...
                  @on-success="
                    (value) =>
                      setUploadSrc(value, 'archiveOtherVO', 'additionalTwoUrl')
                  "
                  @click="
                    handleImgPreview(
                      fileServe + form.archiveOtherVO.additionalTwoUrl
                    )
                  "
                ></upload-pic>
              </el-form-item>
            ...
            <el-col :span="24" v-if="form.archiveBaseVO.archiveType === 9">
              <el-form-item
                label="补充说明"
                prop="archiveOtherVO.additionalRemark"
              >
                <el-input
                  v-model="form.archiveOtherVO.additionalRemark"
                  type="textarea"
                  :autosize="{ minRows: 3 }"
                  resize="none"
                  style="width: 240px"
        ...
        <div class="p-wxArchive-item">
          ...
          <el-row class="p-wxArchive-baseInfo">
            ...
            <el-col :span="12">
              <el-form-item
                label="营业执照"
                prop="archiveExpandVO.businessLicenseUrl"
              >
                <upload-pic
                  alt="营业执照"
                  :hasBase64="true"
                  ...
                  @click="
                    handleImgPreview(
                      fileServe + form.archiveExpandVO.businessLicenseUrl
                    )
                  "
                ></upload-pic>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item label="类目特殊资质">
                <upload-pic
                  ...
                  @on-success="
                    (value) =>
                      setUploadSrc(value, 'archiveOtherVO', 'typeAptitudeUrl')
                  "
                  @click="
                    handleImgPreview(
                      fileServe + form.archiveOtherVO.typeAptitudeUrl
                    )
                  "
                ></upload-pic>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item label="营业执照注册号" prop="archiveExpandVO.licId">
                <el-input
                  v-model="form.archiveExpandVO.licId"
                  placeholder="营业执照注册号"
                  style="width: 240px"
                ></el-input>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item
                label="营业执照有效期"
                prop="archiveExpandVO.licValidityBigen"
              >
                <el-date-picker
                ...
                <span
                  v-if="
                    !form.archiveExpandVO.licValidityEnd &&
                    formDisabled &&
                    pageAction === 'detail'
                  "
                  >长期有效</span
            ...
            <el-col :span="24">
              <el-form-item
                label="经营范围"
                prop="archiveExpandVO.businessScope"
              >
                <el-input
            ...
            <el-col
              :span="24"
              v-if="
                form.archiveBaseVO.archiveType === 9 &&
                [
                  '线下零售/食品生鲜',
                  '休闲娱乐/美发/美容/美甲店',
                  '线下零售/批发业',
                ].includes(form.archiveBaseVO.businessCategoryRemark)
              "
            >
              <el-form-item
                label="售卖商品描述"
                prop="archiveExpandVO.sellShopDescribe"
              >
                <el-input
            ...
            <el-col :span="12" v-if="form.archiveExpandVO.licType === 2">
              <el-form-item
                label="组织机构代码号"
                prop="archiveExpandVO.orgInstitutionCode"
              >
                <el-input
                  v-model="form.archiveExpandVO.orgInstitutionCode"
                  placeholder="组织机构代码号"
                  style="width: 240px"
                ></el-input>
              </el-form-item>
            ...
            <el-col :span="12" v-if="form.archiveExpandVO.licType === 2">
              <el-form-item
                label="组织机构代码有效期"
                prop="archiveExpandVO.orgInstitutionBigen"
              >
                <el-date-picker
                ...
                <span
                  v-if="
                    !form.archiveExpandVO.orgInstitutionEnd &&
                    formDisabled &&
                    pageAction === 'detail'
                  "
                  >长期有效</span
            ...
            <el-col :span="12" v-if="form.archiveExpandVO.licType === 2">
              <el-form-item
                label="组织机构代码证"
                prop="archiveExpandVO.orgInstitutionUrl"
              >
                <upload-pic
                  alt="组织机构代码证"
                  :showExample="false"
                  ...
                  @click="
                    handleImgPreview(
                      fileServe + form.archiveExpandVO.orgInstitutionUrl
                    )
                  "
                ></upload-pic>
              </el-form-item>
            ...
            <el-col :span="12" v-if="form.archiveExpandVO.licType === 2">
              <el-form-item
                label="税务登记证"
                prop="archiveExpandVO.taxRegistrationUrl"
              >
                <upload-pic
                  alt="税务登记证"
                  :showExample="false"
                  ...
                  @click="
                    handleImgPreview(
                      fileServe + form.archiveExpandVO.taxRegistrationUrl
                    )
                  "
                ></upload-pic>
              </el-form-item>
        ...
        <div class="p-wxArchive-item">
          ...
          <el-row class="p-wxArchive-baseInfo">
            <el-col :span="12">
              <el-form-item
                label="身份证正面照"
                prop="archiveExpandVO.idFrontUrl"
              >
                <upload-pic
                  alt="身份证正面照"
                  :hasBase64="true"
                  ...
                  @click="
                    handleImgPreview(
                      fileServe + form.archiveExpandVO.idFrontUrl
                    )
                  "
                ></upload-pic>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item
                label="身份证背面照"
                prop="archiveExpandVO.idBackUrl"
              >
                <upload-pic
                  alt="身份证背面照"
                  :hasBase64="true"
                  ...
                  "
                  @click="
                    handleImgPreview(fileServe + form.archiveExpandVO.idBackUrl)
                  "
                ></upload-pic>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item
                label="法人姓名"
                prop="archiveExpandVO.legalPersonName"
              >
                <el-input
                  v-model="form.archiveExpandVO.legalPersonName"
                  placeholder="法人姓名"
                  style="width: 240px"
                ></el-input>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item label="证件类型" prop="archiveExpandVO.idType">
                <el-select
                  clearable
                  v-model="form.archiveExpandVO.idType"
                  placeholder="证件类型"
                  style="width: 240px"
                >
            ...
            <el-col :span="12">
              <el-form-item label="证件号码" prop="archiveExpandVO.idNumber">
                <el-input
                  v-model="form.archiveExpandVO.idNumber"
                  placeholder="证件号码"
                  style="width: 240px"
                ></el-input>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item label="证件有效期" prop="archiveExpandVO.idBegin">
                <el-date-picker
                  v-model="form.archiveExpandVO.idBegin"
                  type="date"
                  clearable
                  placeholder="开始日期"
                  value-format="yyyy-MM-dd"
            ...
            <el-col :span="12">
              <el-form-item
                label="手持身份证正面照"
                prop="archiveExpandVO.hardIdUrl"
              >
                <upload-pic
                  alt="手持身份证正面照"
                  :fileServer="fileServer"
                  ...
                  @on-success="
                    (value) =>
                      setUploadSrc(value, 'archiveExpandVO', 'hardIdUrl')
                  "
                  @click="
                    handleImgPreview(fileServe + form.archiveExpandVO.hardIdUrl)
                  "
                ></upload-pic>
              </el-form-item>
            </el-col>
        ...
        <div class="p-wxArchive-item">
          ...
          <el-row class="p-wxArchive-baseInfo">
            <el-col :span="24" v-if="form.archiveBaseVO.merchantType === 2">
              <el-form-item
                label="开户许可证"
                prop="archiveExpandVO.openingPermitUrl"
              >
                <upload-pic
                  alt="开户许可证"
                  :showExample="false"
                  ...
                  @on-success="
                    (value) =>
                      setUploadSrc(value, 'archiveExpandVO', 'openingPermitUrl')
                  "
                  @click="
                    handleImgPreview(
                      fileServe + form.archiveExpandVO.openingPermitUrl
                    )
                  "
                ></upload-pic>
              </el-form-item>
            ...
            <el-col :span="24" v-if="form.archiveBaseVO.merchantType === 1">
              <el-form-item
                label="银行卡正面照"
                prop="archiveExpandVO.bankCardFrontUrl"
              >
                <upload-pic
                  alt="银行卡正面照"
                  :fileServer="fileServer"
                  ...
                  @on-success="
                    (value) =>
                      setUploadSrc(value, 'archiveExpandVO', 'bankCardFrontUrl')
                  "
                  @click="
                    handleImgPreview(
                      fileServe + form.archiveExpandVO.bankCardFrontUrl
                    )
                  "
                ></upload-pic>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item label="银行账号" prop="archiveExpandVO.bankCard">
                <el-input
                  v-model="form.archiveExpandVO.bankCard"
                  placeholder="银行账号"
                  style="width: 240px"
                ></el-input>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item
                label="账户名"
                prop="archiveExpandVO.bankAccountName"
              >
                <el-input
                  v-model="form.archiveExpandVO.bankAccountName"
                  placeholder="账户名"
                  style="width: 240px"
                ></el-input>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item
                label="银行所在地区"
                prop="archiveExpandVO.bankArea"
              >
                <area-select
                  :key="bankAreaKey"
                  @change="(value) => handleArea('bankArea', value)"
                  :areaList="bankAreaList"
                ></area-select>
              </el-form-item>
            </el-col>
          </el-row>
        ...
        <div
          class="p-wxArchive-item"
          v-if="form.archiveBaseVO.archiveType === 9"
        >
          ...
          <el-row class="p-wxArchive-baseInfo">
            <el-col :span="12">
              <el-form-item label="费率" prop="archiveBaseVO.fixFeeRate">
                <el-select
                  v-model="form.archiveBaseVO.fixFeeRate"
                  placeholder="费率"
                  style="width: 240px"
                >
                  <el-option
    ...
    <div
      class="p-wxArchive-action"
      v-if="
        pageAction === 'add' ||
        $route.query.status === 'copy' ||
        detailStatusArr.includes(form.archiveBaseVO.auditStatus)
      "
    >
      <el-button
        size="small"
      ...
      <el-button
        ...
        @click="handleArchive"
        >{{
          [2].includes(form.archiveBaseVO.auditStatus) && formDisabled
            ? "编辑"
            : "保存"
        }}</el-button
      >
      <el-button
        ...
        @click="isReason = true"
        v-if="
          [2].includes(form.archiveBaseVO.auditStatus) &&
          $route.query.status !== 'copy'
        "
        >拒绝</el-button
      >
      ...
      >
        <el-form-item label="原因" prop="remark" class="e-dialog-remark">
          <el-input
            ...
            :rows="4"
            placeholder="请输入审核不能过的原因"
          ></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer">
        <el-button
          @click="isReason = false"
          size="small"
          class="e-wxArchive-action_pd"
          >取消</el-button
        >
...
export default {
  ...
  mounted() {
    this.$nextTick(() => {
      ...
      let pageStatus = this.$route.query.status
        ? tags[this.$route.query.status]
        : "新增";
      document.querySelector(
        ".e-tag_active span"
      ).innerText = `普通资质进件/${pageStatus}`;
    });
  },
  ...
  methods: {
    ...
    handleBusinessCategory(val) {
      ...
      this.form.archiveBaseVO.businessCategoryRemark =
        one.label + "/" + two.label;
    ...
    handleDetail: async function () {
      try {
        ...
        this.form.archiveBaseVO =
          res?.archiveBaseDTO ?? deepClone(formObj.archiveBaseDTO);
        this.form.archiveExpandVO =
          res.archiveExpandDTO ?? deepClone(formObj.archiveExpandDTO);
        this.form.archiveOtherVO =
          res.archiveOtherDTO ?? deepClone(formObj.archiveOtherDTO);
        this.areaList = [
          res.archiveBaseDTO.province,
          res.archiveBaseDTO.city,
          res.archiveBaseDTO.area,
        ];
        this.areaKey = Symbol("areaKey");
        this.bankAreaList = [
          res.archiveExpandDTO.bankProvince,
          res.archiveExpandDTO.bankCity,
          res.archiveExpandDTO.bankArea,
        ];
        this.bankAreaKey = Symbol("bankAreaKey");
        if (
          ![0, 1, 4].includes(res.archiveBaseDTO.auditStatus) &&
          this.$route.query.status !== "copy"
        )
    ...
    setIdCardAndBase64(res, base64Code, type, url, side) {
      ...
      imageOCR(OCRData).then((res) => {
        ...
        if (side === "face") {
          ...
          this.form.archiveExpandVO.idBegin =
            res.start_date.slice(0, 4) +
            "-" +
            res.start_date.slice(4, 6) +
            "-" +
            res.start_date.slice(6, 8);
          this.form.archiveExpandVO.idEnd =
            res.end_date.slice(0, 4) +
            "-" +
            res.end_date.slice(4, 6) +
            "-" +
            res.end_date.slice(6, 8);
        }
      });
    ...
    setBusinessLicenseAndBase64(res, base64Code, type, url, side) {
      ...
      imageOCR(OCRData).then(async (res) => {
        ...
        this.form.archiveExpandVO.licValidityBigen =
          res.establish_date.slice(0, 4) +
          "-" +
          res.establish_date.slice(4, 6) +
          "-" +
          res.establish_date.slice(6, 8);
        this.form.archiveExpandVO.licValidityEnd =
          res.valid_period.slice(0, 4) +
          "-" +
          res.valid_period.slice(4, 6) +
          "-" +
          res.valid_period.slice(6, 8);
        // try {
