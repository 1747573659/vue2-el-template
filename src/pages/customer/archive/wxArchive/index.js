...
export const detailValidate = {
  ...
  "archiveOtherVO.signboardUrl": [
    { required: true, message: "请输入门店门头照", trigger: "change" }
  ],
  "archiveOtherVO.businessSiteOneUrl": [
    { required: true, message: "请输入经营场所照1", trigger: "change" }
  ],
  "archiveOtherVO.businessSiteTwoUrl": [
    { required: true, message: "请输入经营场所照2", trigger: "change" }
  ],
  "archiveOtherVO.businessSiteThreeUrl": [
    { required: true, message: "请输入经营场所照3", trigger: "change" }
  ],
  "archiveExpandVO.licType": [
    { required: true, message: "请输入证件类型", trigger: "change" }
  ],
  "archiveExpandVO.businessLicenseUrl": [
  ...
  "archiveExpandVO.licValidityBigen": [
    { required: true, message: "请输入营业执照有效期", trigger: "change" }
  ],
  "archiveBaseVO.businessCategory": [
    { required: true, message: "请输入经营类目", trigger: "change" }
  ],
  "archiveExpandVO.businessScope": [
    { required: true, message: "请输入经营范围", trigger: "change" }
  ],
  "archiveExpandVO.sellShopDescribe": [
    { required: true, message: "请输入售卖商品描述", trigger: "change" }
  ],
  "archiveExpandVO.orgInstitutionCode": [
    { required: true, message: "请输入组织机构代码号", trigger: "change" }
  ],
  "archiveExpandVO.orgInstitutionBigen": [
    { required: true, message: "请输入组织机构代码有效期", trigger: "change" }
  ],
  "archiveExpandVO.orgInstitutionUrl": [
    { required: true, message: "请输入组织机构代码证", trigger: "change" }
  ],
  "archiveExpandVO.taxRegistrationUrl": [
    { required: true, message: "请输入税务登记证", trigger: "change" }
  ],
  "archiveExpandVO.legalPersonName": [
    { required: true, message: "请输入法人姓名", trigger: "change" }
  ],
  "archiveExpandVO.idType": [
    { required: true, message: "请输入证件类型", trigger: "change" }
  ],
  ...
  "archiveExpandVO.idBegin": [
    { required: true, message: "请输入证件有效期", trigger: "change" }
  ],
  "archiveExpandVO.idFrontUrl": [
    { required: true, message: "请输入身份证正面照", trigger: "change" }
  ],
  "archiveExpandVO.idBackUrl": [
    { required: true, message: "请输入身份证背面照", trigger: "change" }
  ],
  "archiveExpandVO.hardIdUrl": [
    { required: true, message: "请输入手持身份证正面照", trigger: "change" }
  ],
  "archiveExpandVO.openingPermitUrl": [
    { required: true, message: "请输入开户许可证", trigger: "change" }
  ],
  "archiveExpandVO.bankCardFrontUrl": [
    { required: true, message: "请输入银行卡正面照", trigger: "change" }
  ],
  "archiveExpandVO.bank": [
    { required: true, message: "请输入银行", trigger: "change" }
  ],
  "archiveExpandVO.bankName": [
    { required: true, message: "请输入银行", trigger: "change" }
  ],
  "archiveExpandVO.bankSub": [
    { required: true, message: "请输入所属支行", trigger: "change" }
  ],
  ...
  "archiveExpandVO.bankArea": [
    { required: true, message: "请输入银行所在地区", trigger: "change" }
  ],
  "archiveBaseVO.fixFeeRate": [
    { required: true, message: "请选择小微交易费率", trigger: "change" }
  ]
};
// 审核不通过原因
...
export const refundRules = {
  remark: [
    { required: true, message: "请输入审核不能过的原因", trigger: "change" }
  ]
};
...
// 小微商户展示商品描述情况
export const sellShopDescribeArr = [
  "线下零售/食品生鲜",
  "休闲娱乐/美发/美容/美甲店",
  "线下零售/批发业"
];
