<template>
  <div class="tree-custom-wrap clearfix">
    ...
    <div class="tree-custom-right">
      <p class="tree-custom-handle-power"><el-checkbox v-model="powerChecked" class="checkbox"></el-checkbox>操作权限</p>
    </div>
  </div>
</template>
...
<style lang="scss">
.tree-custom-wrap .el-tree-node > .el-tree-node__children {
  overflow: inherit;
}
